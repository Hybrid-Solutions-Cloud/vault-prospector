...
Architecture Decision Records document important decisions, their context, alternatives, and consequences.
...
- [ADR-0001: Product scope and guiding principles](0001-product-scope-and-guiding-principles.md)
- [ADR-0002: Local-first architecture](0002-local-first-architecture.md)
- [ADR-0003: .NET and Avalonia technology direction](0003-dotnet-and-avalonia-technology-direction.md)
- [ADR-0004: Separate application unlock from Azure identities](0004-separate-app-unlock-from-azure-identities.md)
- [ADR-0005: Multi-identity and multi-tenant access model](0005-multi-identity-and-multi-tenant-access-model.md)
