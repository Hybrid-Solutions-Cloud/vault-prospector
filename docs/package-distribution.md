...
winget validate --manifest ./artifacts/distribution/winget/HybridSolutionsCloud.VaultProspector/0.2.0-preview.5
```
...
```powershell
pwsh ./scripts/PublishDistribution.ps1 -Version 0.2.0-preview.5
```
...
```powershell
pwsh ./scripts/SubmitPackageManagers.ps1 -Version 0.2.0-preview.5
```
