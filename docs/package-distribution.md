...
winget validate --manifest ./artifacts/distribution/winget/HybridSolutionsCloud.VaultProspector/0.3.0-preview.6
```
...
```powershell
pwsh ./scripts/PublishDistribution.ps1 -Version 0.3.0-preview.6
```
...
```powershell
pwsh ./scripts/SubmitPackageManagers.ps1 -Version 0.3.0-preview.6
```
