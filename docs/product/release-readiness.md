...
| P-11 | Chocolatey package validation and public repository acceptance | Yes | Blocked | The tested package, recorded checksum, and immutable public asset have the same SHA-256. Three authenticated submission attempts on 2026-07-16 returned Chocolatey HTTP 504; exact OData, package-page, and CLI checks after the third attempt prove the version was not ingested. Retry after repository recovery, then complete moderation. |
