...
| P-02 | Locked restore, formatting, warnings-as-errors build, and automated tests | Yes | Passed | Local Release verification on 2026-07-16: restore and formatting passed; build completed with 0 warnings and 0 errors; 33 tests passed. CI repeats these gates on `main`. |
