...
| P-03 | Known dependency vulnerabilities and committed secrets | Yes | Passed | Exact tagged-source CI run [29611412932](https://github.com/Hybrid-Solutions-Cloud/vault-prospector/actions/runs/29611412932) passed the structured direct/transitive NuGet vulnerability gate and pinned full-history Gitleaks scan. The sole release-evidence digest exception is constrained by exact value and path in `.gitleaks.toml`; it cannot suppress any other match. |
