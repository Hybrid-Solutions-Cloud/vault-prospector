...
Version [`0.3.0-preview.20`](https://github.com/Hybrid-Solutions-Cloud/vault-prospector-releases/releases/tag/v0.3.0-preview.20)
...
explicit verified in-app unsigned Preview installation, complete search match totals with additional
result pages, and explicit selected/all-identity synchronization.
