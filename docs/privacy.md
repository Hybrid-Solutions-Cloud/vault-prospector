...
| Optional offline secret value | Allow an explicit offline workflow | Separate AES-GCM envelope with a DPAPI-protected key for the current Windows user | Disabled by default; expires by policy or is purged by the user |
