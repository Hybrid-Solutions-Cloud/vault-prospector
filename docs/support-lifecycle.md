...
evaluation build is `0.3.0-preview.17`. “Supported” at this stage means that the maintainer accepts
...
| --- | --- | --- |
| `0.3.0-preview.17` | Current Preview | Non-production manual testing only |
| `0.3.0-preview.12` | Superseded Preview | Upgrade to `0.3.0-preview.17` |
| `0.3.0-preview.8` | Superseded Preview | Upgrade to `0.3.0-preview.17` |
| `0.3.0-preview.6` | Superseded Preview | Upgrade to `0.3.0-preview.17` |
| `0.3.0-preview.5` | Superseded Preview | Upgrade to `0.3.0-preview.17` |
| `0.3.0-preview.3` | Superseded Preview | Upgrade to `0.3.0-preview.17` |
| `0.3.0-preview.2` | Withdrawn | Do not install; upgrade to `0.3.0-preview.17` |
