...
evaluation build is `0.3.0-preview.20`. “Supported” at this stage means that the maintainer accepts
...
| --- | --- | --- |
| `0.3.0-preview.20` | Current Preview | Non-production manual testing only |
| `0.3.0-preview.19` | Superseded Preview | Manually upgrade once to `0.3.0-preview.20`; Preview 20 handles future updates in-app |
| `0.3.0-preview.18` | Superseded Preview | Upgrade to `0.3.0-preview.20` |
| `0.3.0-preview.17` | Superseded Preview | Upgrade to `0.3.0-preview.20` |
| `0.3.0-preview.12` | Superseded Preview | Upgrade to `0.3.0-preview.20` |
| `0.3.0-preview.8` | Superseded Preview | Upgrade to `0.3.0-preview.20` |
| `0.3.0-preview.6` | Superseded Preview | Upgrade to `0.3.0-preview.20` |
| `0.3.0-preview.5` | Superseded Preview | Upgrade to `0.3.0-preview.20` |
| `0.3.0-preview.3` | Superseded Preview | Upgrade to `0.3.0-preview.20` |
| `0.3.0-preview.2` | Withdrawn | Do not install; upgrade to `0.3.0-preview.20` |
