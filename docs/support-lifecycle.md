...
evaluation build is `0.2.0-preview.5`. “Supported” at this stage means that the maintainer accepts
...
| --- | --- | --- |
| `0.2.0-preview.5` | Current Preview | Non-production evaluation only |
