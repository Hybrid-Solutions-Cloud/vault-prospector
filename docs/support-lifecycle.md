...
evaluation build is `0.3.0-preview.6`. “Supported” at this stage means that the maintainer accepts
...
| --- | --- | --- |
| `0.3.0-preview.6` | Current Preview | Non-production manual testing only |
| `0.3.0-preview.5` | Superseded Preview | Upgrade to `0.3.0-preview.6` |
| `0.3.0-preview.3` | Superseded Preview | Upgrade to `0.3.0-preview.6` |
| `0.3.0-preview.2` | Withdrawn | Do not install; upgrade to `0.3.0-preview.6` |
